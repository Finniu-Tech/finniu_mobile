...
final userDeviceSyncProvider = StateProvider<bool>((ref) {
  return false;
});
  ...
  try {
    ...
    if (result.data?['userProfile'] != null) {
      ...
      ref.read(userProfileNotifierProvider.notifier).updateFields(
            ...
            extRegion: userProfile.extRegion,
            extProvince: userProfile.extProvince,
            extDistrict: userProfile.extDistrict,
...
class UserProfileStateNotifierProvider extends StateNotifier<UserProfile> {
  ...
  void updateFields({
    ...
    state = state.copyWith(
      ...
      provincia: provincia,
      region: region,
      extDistrict: extDistrict,
      extProvince: extProvince,
      extRegion: extRegion,
      country: country,
