...
class Step2Body extends StatefulHookConsumerWidget {
  ...
  @override
  Step2BodyState createState() => Step2BodyState();

  //on init set selectedBankAccountReceiver as null
}

class Step2BodyState extends ConsumerState<Step2Body> {
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            isSoles
                                ? formatterSoles.format(reInvestment.finalAmount)
              ...
              onPressed: () async {
                ...
                if (response.success == true) {
                  ...
                  showSnackBarV2(
                    ...
                    message: response.messages?[0].message ?? 'Hubo un problema al guardar',
                    snackType: SnackType.error,
                  );
                }
              },
